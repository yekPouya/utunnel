...
| **`mux_con`**         | `8`           | `16`          | `24`          | `32`          | `40`          | `48`          | افزایش همزمانی برای کاربران بیشتر. |
| **`mux_framesize`**   | `16384` (16KB)| `32768` (32KB)| `32768` (32KB)| `65536` (64KB)| `65536` (64KB)| `65536` (64KB)| اندازه فریم برای ترافیک متوسط/سنگین. |
| **`mux_recievebuffer`**| `4MB`        | `8MB`         | `16MB`        | `24MB`        | `32MB`        | `48MB`        | بافر دریافت برای جلوگیری از ازدحام. |
| **`mux_streambuffer`**| `32KB`        | `64KB`        | `64KB`        | `128KB`       | `128KB`       | `256KB`       | بافر جریان برای کاربران بیشتر.   |
| **`connection_pool`** | `8`           | `12`          | `16`          | `20`          | `24`          | `32`          | افزایش اتصالات کلاینت.       |
| **`heartbeat`**       | `40`          | `30`          | `25`          | `20`          | `15`          | `10`          | کاهش زمان تشخیص قطعی.        |
| **`channel_size`**    | `2048`        | `4096`        | `8192`        | `12288`       | `16384`       | `24576`       | افزایش ظرفیت کانال ارتباطی.  |
| **`log_level`**       | `info`        | `warn`        | `warn`        | `error`       | `error`       | `error`       | کاهش لاگ برای عملکرد بهتر.   |
...
✅ **مانیتورینگ**:  
- از **`htop`**, **`nload`**, و **`journalctl -u utunnel`** برای بررسی وضعیت استفاده کنید.  
- برای سرورهای بزرگ، **Prometheus + Grafana** راه‌حل بهتری است.  
